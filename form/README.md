...
```
<script type="text/javascript" src="savvy.js"></script>
<link rel="stylesheet" type="text/css" href="savvy.css" />
```

2. Paste the contents of `savvy.html` to the place where your form should appear.
...
```
<button id="savvy-all">Pay with Crypto</button>
```
...
5. Set up your backend as described in [one of the examples](https://github.com/savvyio/savvy-samples)
...
<table>
	...
	<tr><td>address</td><td>Wallet address to show to the client (generated by Savvy API call). For multi currency forms use `currencyUrl` parameter instead</td><td>"0x39ee76948d238fad2b750998f8a38d80c73c7cd7"</td></tr>
</table>
...
# Code contributions
- Have a suggestion or found a bug? Please [email us](mailto:contact@savvy.io) or [ping our Telegram](https://t.me/getsavvyio)
